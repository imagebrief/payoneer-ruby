...
module Payoneer
  class Payee
    ...
    def self.signup_url(payee_id, payout_method=nil, existing_account=false, redirect_url=nil, redirect_time=nil)
      payoneer_params = {
        p4: payee_id,
        p6: redirect_url,
        p8: redirect_time,
      ...
      payoneer_params = payoneer_params.merge({p11: payout_method}) if payout_method
